        ...
        children: [
          ...
          if (selectedUIAction != null && selectedUIAction!.subActions.isNotEmpty) ...[
            ...
            Container(
              ...
              child: Text(
                  "詳細 (${selectedUIAction!.isSubRequired ? '必須' : '任意'}):",
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      color: selectedUIAction!.isSubRequired ? Colors.red : Colors.grey
                  )
              ),
            ),
            Expanded(
                ...
                itemBuilder: (context, index) {
                  ...
                  return OutlinedButton(
                    style: OutlinedButton.styleFrom(
                      backgroundColor: isSelected ? Colors.indigoAccent : Colors.white,
                      foregroundColor: isSelected ? Colors.white : Colors.black87,
                    ),
                    onPressed: () => onSubActionSelected(sub),
                    child: Text(sub),
                  );
                },
              ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: Wrap(
              ...
              children: [
                ...
                Text(
                    selectedPlayer != null
                        ? "$selectedPlayer ${playerNames[selectedPlayer] != null ? '(${playerNames[selectedPlayer]})' : ''}"
                        : "-",
          ...
          ElevatedButton.icon(
            onPressed: (hasMatchStarted && selectedPlayer != null && selectedUIAction != null)
                ? onConfirm
                : null,
            style: ElevatedButton.styleFrom(
